const questionBank = [
    ...
    { banca: 'IBFC', question: 'Qual estrutura anatômica é o principal ponto de drenagem dos seios frontal, maxilar e etmoidal anterior?', options: ['Hiato semilunar', 'Recesso esfenoetmoidal', 'Meato nasal inferior', 'Bula etmoidal', 'Agger nasi'], answer: 'Hiato semilunar', explanation: 'O hiato semilunar, localizado no meato médio, é a via de drenagem final para os seios maxilar, frontal e etmoidal anterior, formando o complexo ostiomeatal.' , tags: ["rinologia"] },
    { banca: 'FUNDATEC', question: 'A cirurgia endoscópica funcional dos seios paranasais (FESS) tem como princípio fundamental:', options: ['A remoção completa de toda a mucosa dos seios paranasais.', 'A criação de grandes aberturas de drenagem artificial.', 'A restauração da ventilação e drenagem fisiológica dos seios.', 'O uso de antibióticos de longa duração no pós-operatório.', 'A correção exclusiva do desvio de septo.'], answer: 'A restauração da ventilação e drenagem fisiológica dos seios.', explanation: 'O conceito da FESS é remover obstruções nos óstios de drenagem naturais dos seios, restaurando a via mucociliar fisiológica, em vez de criar aberturas não anatômicas.' , tags: ["rinologia"] },
    { banca: 'VUNESP', question: 'O que caracteriza a rinite gustativa?', options: ['Coriza aquosa após ingestão de alimentos, especialmente os picantes.', 'Obstrução nasal ao sentir o cheiro de certos alimentos.', 'Espirros em salvas ao entrar em restaurantes.', 'Prurido nasal causado por alergia alimentar.', 'Rinorreia induzida pelo consumo de álcool.'], answer: 'Coriza aquosa após ingestão de alimentos, especialmente os picantes.', explanation: 'A rinite gustativa é uma rinite não alérgica caracterizada por rinorreia aquosa proeminente desencadeada pela ingestão de alimentos, tipicamente quentes ou condimentados.' , tags: ["rinologia"] },
    { banca: 'IBFC', question: 'Qual o tratamento para um hematoma septal não tratado?', options: ['Drenagem e tamponamento nasal', 'Antibioticoterapia isolada', 'Observação, pois a resolução é espontânea', 'Uso de vasoconstritores tópicos', 'Cauterização química'], answer: 'Drenagem e tamponamento nasal', explanation: 'Um hematoma septal deve ser drenado com urgência para evitar complicações como abscesso septal e necrose da cartilagem, que pode levar a uma deformidade em sela. A drenagem é seguida de tamponamento para evitar a recorrência.' , tags: ["rinologia"] },

    // LARINGOLOGIA E BUCOFARINGE
    { banca: 'IBFC', question: 'Professora de 35 anos, não fumante, refere rouquidão que piora ao final do dia, sem outros sintomas. A videolaringoscopia revela lesões nodulares, bilaterais e simétricas no terço médio das pregas vocais. Qual a conduta inicial mais adequada?', options: ['Exérese cirúrgica das lesões', 'Repouso vocal absoluto por 30 dias', 'Terapia fonoaudiológica', 'Injeção de toxina botulínica', 'Uso de anti-inflamatórios'], answer: 'Terapia fonoaudiológica', explanation: 'O quadro é típico de nódulos vocais ("calos"), causados por abuso ou mau uso vocal. O tratamento de primeira linha é sempre a fonoterapia para reeducação vocal.' , tags: ["laringologia"] },
    { banca: 'IBFC', question: 'Qual das seguintes condições é a principal indicação para amigdalectomia em crianças, segundo os critérios de Paradise?', options: ['Um episódio de abscesso periamigdaliano', 'Halitose crônica', 'Amigdalite de repetição', 'Roncos primários', 'Disfagia leve'], answer: 'Amigdalite de repetição', explanation: 'Os critérios de Paradise estabelecem a frequência de infecções (ex: 7 ou mais episódios em 1 ano) como a principal indicação cirúrgica para amigdalite de repetição.' , tags: ["laringologia"] },
    { banca: 'FUNDATEC', question: 'A lesão laríngea caracterizada por um sulco ou invaginação do epitélio ao longo da borda livre da prega vocal, causando rouquidão importante, é denominada:', options: ['Pólipo vocal', 'Cisto epidermoide', 'Granuloma de contato', 'Sulco vocal', 'Edema de Reinke'], answer: 'Sulco vocal', explanation: 'O sulco vocal é uma depressão na prega vocal que altera a vibração da mucosa, resultando em disfonia significativa, muitas vezes com soprosidade e qualidade vocal áspera.' , tags: ["laringologia"] },
